from PyQt5.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QCheckBox, QPushButton, QMessageBox
...
class SettingsWindow(QWidget):
    ...
    def _save_settings(self):
        ...
        config.update_config(ws_url=ws_url, auth_enabled=auth_enabled, auth_token=auth_token)
